...
export default function ETFMetrics({ etf }) {
  if (!etf) return null;
  ...
  return (
    <div className="bg-primary-500/10 backdrop-blur-sm rounded-lg p-4 shadow-md border border-primary-500/20 w-full">
      ...
      <div className="grid grid-cols-4 gap-4 pt-4 border-t border-primary-500/20">
        ...
        <div className="flex flex-col items-center justify-center">
          <h4 className="text-primary-300 text-xs font-medium mb-1">52W Range</h4>
          <p className="text-primary-200 text-sm font-semibold drop-shadow-[0_0_4px_rgba(221,214,254,0.4)]">
            ${additionalMetrics.low52w} - ${additionalMetrics.high52w}
          </p>
        </div>
      </div>
    </div>
